========================================================================
    ACTIVE TEMPLATE LIBRARY : CoCUDAServer Project Overview
========================================================================

AppWizard has created this CoCUDAServer project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

CoCUDAServer.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

CoCUDAServer.vcxproj.filters
...
CoCUDAServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CoCUDAServer.h)
        GUID definitions                                (CoCUDAServer_i.c)
        A type library                                  (CoCUDAServer.tlb)
        Marshaling code                                 (CoCUDAServer_p.c and dlldata.c)

CoCUDAServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CoCUDAServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CoCUDAServer.pch and a precompiled types file named StdAfx.obj.
...
CoCUDAServerps.vcxproj
	...
	dlldata.c, CoCUDAServer_i.c and CoCUDAServer_p.c which are required
	to build the proxy/stub DLL.

CoCUDAServerps.vcxproj.filters
